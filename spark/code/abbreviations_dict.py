""""
The two dictionaries below are used in the python files
in this folder.
- tofullname is a dictionary containing the abbreviations for
each country.
- toevent is a dictionary containing the abbreviations for each
news event
"""
tofullname = {
    "AA":"Aruba",
...
toevent = {
    ...
    "IMG":"International Military Groups",
    "INT":"International/transnational Actors",
